...
// import "./App.css";
// import myImage from "./wokoLogo.webp";

// function App() {
//   return (
//     <div className="black-page">
//       <h1 className={`changelog-heading gradient-heading`}>Changelog</h1>
//       <p className="new-updates">New updates and improvements to Worko</p>
//       <img src={myImage} alt="Logo" />
//       <div className="security-update">
//         <div className="dates">October 13, 2023</div>
//         <h2>Worko Security Update</h2>
//         <div className="security-update-content">
//           <p>
...
//           <ul>
//             <li>
//               Two-Factor Authentication (2FA): We've added support for
...
//             </li>
//             <li>
//               Data Encryption: Worko now uses advanced encryption protocols to
//               secure your data, both in transit and at rest. Your information is
//               shielded from unauthorized access.
//             </li>
//             <li>
//               Regular Security Audits: We conduct regular security audits and
//               vulnerability assessments to identify and address potential
//               threats proactively.
//             </li>
//             <li>
//               User Access Controls: Enhanced user access controls allow you to
//               manage permissions and restrict access to sensitive information
//               within your Worko workspace.
//             </li>
//           </ul>
//           <p>
...
//       </div>
//       <img src={myImage} alt="Logo" />
//       <div className="premium-updates">
//         <div className="dates">October 13, 2023</div>
//         <h2>Worko Premium Plan Enhancements</h2>
//         <div className="premium-updates-content">
//           <p>
...
//           <ul>
//             <li>
//               Custom Task Templates: Premium users can now create and save
//               custom task templates, streamlining the task creation process for
//               recurring tasks or project-specific templates.
//             </li>
//             <li>
//               Advanced Reporting: Unlock advanced reporting features with Worko
//               Premium. Generate detailed reports on task performance, team
//               productivity, and more, all in one place.
//             </li>
//             <li>
//               Enhanced Integrations: Premium users enjoy priority access to new
//               integrations and updates, ensuring you stay at the forefront of
...
//             </li>
//             <li>
//               Task History: Premium users can now access an extended task
...
//         <div className="integrations-update-content">
//           <p>
...
//           <ul>
//             <li>
//               Slack Integration: Now you can seamlessly connect your Worko
//               workspace with Slack. Receive task notifications and updates
//               directly in your Slack channels, enhancing team communication.
//             </li>
//             <li>
//               Google Calendar Integration: Streamline your scheduling with
//               Worko's Google Calendar integration. Sync your tasks and deadlines
//               with your Google Calendar for a comprehensive view of your day.
//             </li>
//             <li>
//               Trello Integration: If you're a Trello user, you'll love our
//               enhanced Trello integration. Easily import Trello boards into
//               Worko and vice versa, making cross-platform task management a
//               breeze.
//             </li>
//             <li>
//               Asana Integration: Worko's Asana integration has been revamped for
//               improved task syncing and collaboration between the two platforms.
//             </li>
//             <li>
//               Microsoft Teams Integration: Connect Worko with Microsoft Teams to
//               foster seamless task management within your Teams workspace. Share
//               task updates, assignments, and deadlines without leaving Teams.
//             </li>
//           </ul>
//           <p>
...
//         <div className="analytics-update-content">
//           <p>
...
//           <ul>
//             <li>
//               Task Performance Metrics: Gain insights into task completion
//               rates, average task duration, and more. Use this data to identify
//               bottlenecks and improve task efficiency.
//             </li>
//             <li>
//               Team Productivity Dashboard: Monitor your team's productivity with
//               a centralized dashboard. Track completed tasks, overdue tasks, and
//               team members' performance.
//             </li>
//             <li>
//               Custom Reports: Create custom reports to analyze task data based
//               on your unique needs. Visualize your data with charts and graphs
//               for a deeper understanding.
//             </li>
//             <li>
//               Export Data: Need to share or analyze your data outside of Worko?
//               You can now export task data to CSV files for further analysis or
//               reporting.
//             </li>
//           </ul>
//         </div>
//       </div>
//       <img src={myImage} alt="Logo" />
//       <div className="collaboration-update">
//         <div className="dates">October 13, 2023</div>
//         <h2>Real-time Collaboration in Worko</h2>
//         <div className="collaboration-update-content">
//           <p>
...
//           <ul>
//             <li>
//               Live Task Updates: When you and your team members work on the same
//               task, changes are now reflected in real-time. No more confusion or
//               overlapping efforts.
//             </li>
//             <li>
//               Task Comments: Leave comments on tasks to provide context, share
//               ideas, or ask questions. Comments keep the conversation organized
//               and help you communicate effectively.
//             </li>
//             <li>
//               Task Sharing: Easily share tasks with team members, making it
//               simple to delegate responsibilities and keep everyone aligned.
//             </li>
//             <li>
//               Notifications: Stay informed with instant notifications about task
//               updates, comments, and mentions. Never miss an important
//               development again.
//             </li>
//           </ul>
//           <p>
...
//           <ul>
//             <li>
//               Sleek New Design: We've given Worko a fresh, modern look. The user
//               interface is now more intuitive than ever, making task management
//               a breeze.
//             </li>
//             <li>
//               Enhanced Mobile Experience: With the new mobile-responsive design,
//               Worko is fully optimized for smartphones and tablets. You can
//               manage tasks and stay productive while on the move.
//             </li>
//             <li>
//               Task Dependencies: You asked, and we delivered. Worko now supports
//               task dependencies, allowing you to define the order in which tasks
//               should be completed. This feature is a game-changer for project
//               management and complex workflows.
//             </li>
//             <li>
//               Improved Performance: We've fine-tuned Worko's performance to
//               ensure lightning-fast task loading and smoother interactions, even
//               when dealing with extensive task lists.
//             </li>
//             <li>
//               Worko Premium: Along with this update, we're introducing Worko
//               Premium. Upgrade to access advanced features like unlimited task
//               history, priority support, and integrations with popular
//               productivity tools.
//             </li>
//           </ul>
//         </div>
...
function App() {
  const gradientStyle = {
    backgroundImage: "linear-gradient(to top, #333, #ddd)", // Dark gray at the bottom to light gray at the top
    WebkitBackgroundClip: "text",
    color: "transparent",
    fontFamily: "Inter, system-ui, Avenir, Helvetica, Arial, sans-serif", // Your specified font-family
  };
  return (
    <div className="black-page">
      <h1
